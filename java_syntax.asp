...
<script src="/lib/my-learning.js?v=1.0.10"></script>
...
@media screen and (max-width: 1160px) {
  ...
  <div class="w3-right w3-padding-16">
    ...
    <a class="w3-bar-item w3-button bar-item-hover w3-right ws-hide-900 w3-hide-small ws-hide-1066 barex topnavmain_pro" style="border-radius: 25px; margin-right: 15px;" href="/pro/index.php" target="_blank" title="Go pro and unlock powerful features">Pro <span class="ribbon-topnav ws-hide-1160">NEW</span></a>    
...
<a target="_top" href="java_variables_multiple.asp">Declare Multiple Variables</a>
...
<a target="_top" href="java_files_create.asp">Java Create/Write Files</a>
<a target="_top" href="java_files_read.asp">Java Read Files</a>
<a target="_top" href="java_files_delete.asp">Java Delete Files</a>
<br>

<h2>Java How To</h2>
<a target="_top" href="java_howto_add_two_numbers.asp">Add Two Numbers</a>
<br>
...
<h1>Java <span class="color_h1">Syntax</span></h1>
...
<!--
<p>We will use them in almost all of our examples, and you will get to know them bit by bit while reading this tutorial.</p>
...
<div>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.asp?filename=exercise_syntax1" method="post" target="_blank">
